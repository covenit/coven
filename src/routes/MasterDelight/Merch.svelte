<script>
    ...
    const charact = [
        {c: 'Cottura a convezione'},
        {c: 'Regolazione velocità della ventola'},
        {c: 'Umidificatore automatico e manuale'},
        {c: 'Inversione di rotazione della ventola'}
    ]
    ...
    /*Images of details*/
    const imageDetails = "/details/masterdelight/mech.png";
