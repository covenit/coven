<script>
    ...
    const charact = [
        {c: 'Sistema di lavaggio automatico'},
        {c: 'Regolazione della percentuale di umidità'},
    ...
    /*Images of details*/
    const imageDetails = "/details/steadycook/visual.webp";
